...
const UserInfo = () => {
  return (
    <div className="mb-8 w-full flex border-t border-contact-shades-gray-1 pt-6 gap-2.5 h-[62px] cursor-pointer items-center sm:pt-0 sm:border-none sm:w-auto sm:min-w-[130px] md:justify-end lg:gap-2.5 lg:border-t lg:h-[62px] lg:p-6 lg:pb-0 lg:w-full lg:border-contact-shades-gray-1 lg:justify-start">
